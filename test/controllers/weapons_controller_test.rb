...
class WeaponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weapon" do
    assert_difference('Weapon.count') do
      post weapons_url, params: { weapon: { description: @weapon.description, name: @weapon.name, type: @weapon.type } }
    end
  ...
  test "should update weapon" do
    patch weapon_url(@weapon), params: { weapon: { description: @weapon.description, name: @weapon.name, type: @weapon.type } }
